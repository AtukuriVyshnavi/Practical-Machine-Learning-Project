...
```{r Getting started}
#Loading the train data
pml_train=read.csv("C:\\Users\\vsn\\Desktop\\Practical-Machine-Learning-Project\\pml-training.csv", header=T, sep=",", na.strings=c(""," ",NA))
```
...
```{r}
#Loading the train data
pml_test=read.csv("C:\\Users\\vsn\\Desktop\\Practical-Machine-Learning-Project\\pml-training.csv", header=T, sep=",", na.strings=c(""," ",NA))
#Sorting the columns based on number of NA's
...
```
The predictions for the 20 test observations with both the models can be seen here. 
